...
def write_car_series_to_db(car_mark,d):
    """
...
if __name__ == "__main__":
    ...
    json_data = urllib.request.urlopen(get_ajax_for_car_series('144')).read().decode()
    data = get_car_series(json_data)
    print (data)
    print (len(data))
